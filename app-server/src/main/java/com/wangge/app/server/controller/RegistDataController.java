...
public class RegistDataController {
	...
	public ResponseEntity<Object> list(@PathVariable("regionId") String regionId) {
		return httpRequestHandler.exchange(url + "/{regionId}/regist_data", HttpMethod.GET,null,null,Object.class,regionId);
	}
	...
	public ResponseEntity<Object> add(@PathVariable("regionId") String regionId, @PathVariable("saojieId") String saojieId,
		...
		return httpRequestHandler.exchange(url + "/{regionId}/{saojieId}/regist_data", HttpMethod.POST,null,jsons,Json.class,regionId,saojieId);
	}
	...
	public ResponseEntity<Object> updateDataSaojie(@RequestBody JSONObject jsons) {
		return httpRequestHandler.exchange(url + "/update_registData", HttpMethod.POST,null,jsons,Json.class,null);
	}
	...
	public ResponseEntity<Object> registDataInfo(@PathVariable("registDataId") String registDataId) {
		return httpRequestHandler.exchange(url + "/{registDataId}/infoRegist", HttpMethod.GET,null,null,RegistData.class,registDataId);
	}

	@RequestMapping(value = "/rd/registData", method = RequestMethod.POST)
	public ResponseEntity<Object> list() {
		return httpRequestHandler.exchange(url + "/rd/registData", HttpMethod.POST,null,null,List.class,null);
	}
}
