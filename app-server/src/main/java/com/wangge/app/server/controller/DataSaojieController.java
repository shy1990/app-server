...
public class DataSaojieController {
	...
	public ResponseEntity<List<DataSaojie>> list(@PathVariable("regionId") String regionId){
		logger.debug("regionId:"+regionId);
		
		List<DataSaojie> Data = dataSaojieService.getSaojieDataByregionId(regionId);
	...
	public ResponseEntity<DataSaojie> add(@PathVariable("username") String username,@RequestBody JSONObject json){
