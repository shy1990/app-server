...
public class AssessController {
	...
	public ResponseEntity<Object> findAllTask(String userid){
		return httpRequestHandler.exchange(url + "/assess/findAllAssess", HttpMethod.POST,null,userid);
	}
	...
	public ResponseEntity<Object> addAssess(String salesmanid,String assessStage,String assessActivenum,String assessOrdernum,String assessCycle,String accessTime,String regionid,String regionzh,String taskid){
		return httpRequestHandler.exchange(url + "/assess/addAssess", HttpMethod.POST,null,salesmanid,assessStage,assessActivenum,assessOrdernum,assessCycle,accessTime,regionid,regionzh,taskid);
	}
