...
public class MonthTaskServiceImpl implements MonthTaskServive {
   ...
   * @return
   */
  private ResponseEntity<Map<String, Object>> generateErrorResp(Map<String, Object> taskmap, String flag, String msg) {
    taskmap.clear();
  ...
  public Map<String, Object> findTask(Map<String, Object> params, Pageable pageRequest) throws Exception {
    ...
    for (MonthTaskSub tasksub : dlist) {
      ...
      SubtaskVo vo = new SubtaskVo(regData.getShopName(), regData.getId() + "", mtsbd.getMonth(), tasksub.getGoal(),
  ...
  /*
   * {       "code": 0,   “msg”:””, “goal”:15, “done”:10, “shopName”:”章丘魅族手机专卖”,
   * “visit”:[ {“day”:28,”action”:”送货”,”time”:”08:23”},
