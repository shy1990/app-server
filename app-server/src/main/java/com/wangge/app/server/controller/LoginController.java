...
public class LoginController {
	...
	public ResponseEntity<JsonCustom> login(@RequestBody JSONObject jsons) {
		...
		if (salesman != null && !"".equals(salesman.getId())) {
			...
			} else if (salesman.getSimId() != null && !"".equals(salesman.getSimId())
					&& simId.equals(salesman.getSimId())) {
	...
	/**
	 * 
	 * @Title: returnLogSucMsg @Description: TODO(返回主账号信息) @param @param
	 * json @param @param salesman @param @return 设定文件 @return
	 * ResponseEntity<JsonCustom> 返回类型 @throws
	 */
	...
	/**
	 * 
	 * @Title: returnLogSucMsg @Description: TODO(返回子账号信息) @param @param
	 * json @param @param salesman @param @param childAccount @param @return
	 * 设定文件 @return ResponseEntity<JsonCustom> 返回类型 @throws
	 */
