...
//			msg={\"title\":\"天桥区扫街任务\",\"content\":\"天桥区可以开始扫啦啦啦啦!!!\",\"mobile\":\"18764157959\"}	;
		 ...
		 * @date 2015年11月13日
		 */
		public static String sendOrder(String title,String msg,String alias,String ordernum,String skuNum,String accCount,String type) {
		    // 在实际业务中，建议 sendNo 是一个你自己的业务可以处理的一个自增数字。
		  String sendNo=getRandomSendNo()+"";
			Map<String, Object> extra = new HashMap<String, Object>();
			extra.put("ordernum", ordernum);
			extra.put("skuNum", skuNum);
			extra.put("accNum", accCount);
			extra.put("type", type);
			jpush = new JPushClient(masterSecret, appKey, timeToLive, DeviceEnum.Android);
//			jpush.setEnableSSL(true);
			MessageResult msgResult = null;
			if("all".equalsIgnoreCase(alias)){
				msgResult = jpush.sendNotificationWithAppKey(sendNo, title, msg, 1, extra);
